...
```markdown
# list_sentences_by_categories.py — README
...
- Run (example):
  python list_sentences_by_categories.py \
    --input-dir ./texts \
    --categories-file word_list/word_categories\(ESG\).txt \
    --theme-file word_list/word_list.txt \
    --output-file results/word_counts.xlsx
